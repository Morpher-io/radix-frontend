...
<template>
  ...
  >
    <div class="flex flex-wrap items-center justify-between mx-auto p-4 max-w-6xl">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        ...
        >
          ...
          <li>
            <a
              href="https://oracle.morpher.com/markets"
              class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              activeClass="text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
              aria-current="page"
  ...
  <main class="relative flex justify-center mx-auto max-w-6xl px-3 ">
    <div class="flex-auto min-w-0 px-4 py-7">
